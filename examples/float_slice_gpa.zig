//! Example: floatSlice (f64) flag with GeneralPurposeAllocator.
...
var fs = pflag.FlagSet.init(alloc, "float-slice-gpa");
defer fs.deinit();
...
std.debug.print("[float_slice/gpa] OK: {d} items: [", .{scores.items.len});
